...
use Michaeld555\SicoobPix;
use stdClass;


class RequestPixMaker
{
    ...
    private SicoobPix $sicoob;

    private array $certificatePub;

    private array $certificatePriv;

    public function __construct(SicoobPix $sicoob, bool $debug = false)
    {
        ...
        $this->base_url = !$sicoob->getIsProduction() ? EnvironmentUrls::sandbox_pix_url : EnvironmentUrls::production_pix_url;
